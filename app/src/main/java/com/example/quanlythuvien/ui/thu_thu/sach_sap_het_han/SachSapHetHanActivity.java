package com.example.quanlythuvien.ui.thu_thu.sach_sap_het_han;
...
import com.example.quanlythuvien.databinding.ActivitySachSapHetHanBinding;
...
import com.example.quanlythuvien.ui.thu_thu.CustomDialog;
import com.example.quanlythuvien.ui.thu_thu.SachQuaHanActivity;
...
public class SachSapHetHanActivity extends AppCompatActivity implements SachHetHanAdapter.ISachHetHan{

    private ActivitySachSapHetHanBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this,R.layout.activity_sach_sap_het_han);
        ...
        binding.imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(SachSapHetHanActivity.this, ThuThuActivity.class);
    ...
    public void onClickSendEmail(int position) {
        Toast.makeText(this, "Chưa đến lúc quá hạn !", Toast.LENGTH_SHORT).show();
    }
